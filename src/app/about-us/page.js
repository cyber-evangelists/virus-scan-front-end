      ...
      <div className="min-h-screen flex items-center justify-center text-white mt-[3rem]">
        <div className="w-full max-w-lg p-8 bg-white dark:bg-gray-800 rounded-lg shadow-md border">
          ...
          <p className="text-gray-700 dark:text-white">
            We are not just a team; we are a family on a mission. At Virus Scan,
            we believe in creating experiences, not just products. Lorem ipsum
            dolor sit amet, consectetur adipiscing elit. Sed cursus ante dapibus
            diam. Integer nec odio. Praesent libero.
          </p>
          ...
          <p className="mt-4 text-gray-700 dark:text-white">
            📬 Connect with us on social media or drop us an email. We are
            excited to hear from you and share this journey together!
          </p>
